...
import net.floodlightcontroller.core.web.PacketTraceResource;
...
public class LoadBalancerREST implements IOFMessageListener, IFloodlightModule, ILoadBalancerREST {
	...
	protected ConcurrentCircularBuffer<SwitchMessagePair> buffer; // Circular buffer for the interface
	...
	public String getName() {
		return LoadBalancerREST.class.getSimpleName();
	}
	...
	public class LoadBalancerWebRoutable implements RestletRoutable {
	    ...
	    public Restlet getRestlet(Context context) {
	        ...
	        // Add a test resource
	        router.attach("/test/json", TestResource.class);
	        
	        // Add get server info res
	        router.attach("/getserver/json", GetServerInfo.class);
	        
	        // Add chenge timeout res
	        router.attach("/timeout/json", ChangePeriod.class);
	...
	public void setHardTimeout(int newValue){
		...
		this.HARD_TIMEOUT = (short) newValue;
